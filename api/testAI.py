...
def query_groq(prompt: str, model: str = "llama-3.3-70b-versatile") -> str:
    """
    Send a prompt to Groq's chat completion API and return the assistant's reply.
    """
    headers = {
        "Content-Type": "application/json",
        "Authorization": "Bearer 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"
    }
...
"""
prompt = f"{explication} ton role est d'expliquer cette sorties {output} avec les paramètres{parameter} en te basant sur cet exemple {exemple}"
